...
const SliderHome = () => {
  ...
  return (
    ...
    >
      {/* Carousel wrapper */}
      <div className="relative h-96 md:h-80 flex justify-center items-center overflow-hidden rounded-lg mx-6 md:mx-20 sliderHomebg">
        {slides.map((slide, index) => (
          ...
          >
            {slide.type === "text" && (
              <blockquote className="text-center p-8 md:px-60 text-xl pb-20 text-white">
                {slide.content}
